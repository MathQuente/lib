...
-- RedefineTables
PRAGMA foreign_keys=OFF;
CREATE TABLE "new__DLCToPublisher" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,
    CONSTRAINT "_DLCToPublisher_A_fkey" FOREIGN KEY ("A") REFERENCES "dlcs" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "_DLCToPublisher_B_fkey" FOREIGN KEY ("B") REFERENCES "publishers" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new__DLCToPublisher" ("A", "B") SELECT "A", "B" FROM "_DLCToPublisher";
DROP TABLE "_DLCToPublisher";
ALTER TABLE "new__DLCToPublisher" RENAME TO "_DLCToPublisher";
...
CREATE TABLE "new__DLCToPlatform" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,
    CONSTRAINT "_DLCToPlatform_A_fkey" FOREIGN KEY ("A") REFERENCES "dlcs" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "_DLCToPlatform_B_fkey" FOREIGN KEY ("B") REFERENCES "platforms" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new__DLCToPlatform" ("A", "B") SELECT "A", "B" FROM "_DLCToPlatform";
DROP TABLE "_DLCToPlatform";
ALTER TABLE "new__DLCToPlatform" RENAME TO "_DLCToPlatform";
...
CREATE TABLE "new__DLCToGameCategory" (
    "A" TEXT NOT NULL,
    "B" INTEGER NOT NULL,
    CONSTRAINT "_DLCToGameCategory_A_fkey" FOREIGN KEY ("A") REFERENCES "dlcs" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "_DLCToGameCategory_B_fkey" FOREIGN KEY ("B") REFERENCES "game_categories" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new__DLCToGameCategory" ("A", "B") SELECT "A", "B" FROM "_DLCToGameCategory";
DROP TABLE "_DLCToGameCategory";
ALTER TABLE "new__DLCToGameCategory" RENAME TO "_DLCToGameCategory";
...
CREATE TABLE "new_game_launchers" (
    ...
    CONSTRAINT "game_launchers_dlc_id_fkey" FOREIGN KEY ("dlc_id") REFERENCES "dlcs" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_game_launchers" ("dateRelease", "dlc_id", "game_id", "id", "plataform_id") SELECT "dateRelease", "dlc_id", "game_id", "id", "plataform_id" FROM "game_launchers";
DROP TABLE "game_launchers";
ALTER TABLE "new_game_launchers" RENAME TO "game_launchers";
CREATE TABLE "new__DLCToGameStudio" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,
    CONSTRAINT "_DLCToGameStudio_A_fkey" FOREIGN KEY ("A") REFERENCES "dlcs" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "_DLCToGameStudio_B_fkey" FOREIGN KEY ("B") REFERENCES "game_studios" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new__DLCToGameStudio" ("A", "B") SELECT "A", "B" FROM "_DLCToGameStudio";
DROP TABLE "_DLCToGameStudio";
ALTER TABLE "new__DLCToGameStudio" RENAME TO "_DLCToGameStudio";
