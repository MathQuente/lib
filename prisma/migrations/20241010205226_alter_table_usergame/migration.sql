/*
  ...
  - The primary key for the `user_games` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
CREATE UNIQUE INDEX "user_games_user_id_game_id_dlc_id_key" ON "user_games"("user_id", "game_id", "dlc_id");
